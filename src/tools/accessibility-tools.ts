...
export const actionSchema = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('clear_text'), nodeId }),
  z.object({ type: z.literal('select_text'), nodeId }),
  z.object({ type: z.literal('copy'), nodeId }),
  z.object({ type: z.literal('paste'), nodeId }),
